...
- [mason-org/mason-registry](https://github.com/mason-org/mason-registry) ([2025-11-19-cyan-crust](https://github.com/mason-org/mason-registry/releases/tag/2025-11-19-cyan-crust), today) - Core registry for mason.nvim.
...
- [telepresenceio/telepresence](https://github.com/telepresenceio/telepresence) ([v2.26.0-test.1](https://github.com/telepresenceio/telepresence/releases/tag/v2.26.0-test.1), 2 days ago) - Local development against a remote Kubernetes or OpenShift cluster
...
- [fix: oidc jwks conformance](https://github.com/teutonet/cluster-api-provider-hosted-control-plane/pull/39) on [teutonet/cluster-api-provider-hosted-control-plane](https://github.com/teutonet/cluster-api-provider-hosted-control-plane) (today)
- [feat: add hash for kube-root-ca.crt configmap to konnectivity-agent](https://github.com/teutonet/cluster-api-provider-hosted-control-plane/pull/38) on [teutonet/cluster-api-provider-hosted-control-plane](https://github.com/teutonet/cluster-api-provider-hosted-control-plane) (today)
