...
- [telepresenceio/telepresence](https://github.com/telepresenceio/telepresence) ([v2.26.0-test.5](https://github.com/telepresenceio/telepresence/releases/tag/v2.26.0-test.5), today) - Local development against a remote Kubernetes or OpenShift cluster
- [mason-org/mason-registry](https://github.com/mason-org/mason-registry) ([2026-01-09-queasy-kanyu](https://github.com/mason-org/mason-registry/releases/tag/2026-01-09-queasy-kanyu), today) - Core registry for mason.nvim.
...
- [kubernetes-sigs/cluster-api](https://github.com/kubernetes-sigs/cluster-api) ([v1.10.10](https://github.com/kubernetes-sigs/cluster-api/releases/tag/v1.10.10), 1 day ago) - Home for Cluster API, a subproject of sig-cluster-lifecycle
- [teutonet/teutonet-helm-charts](https://github.com/teutonet/teutonet-helm-charts) ([base-cluster-v11.0.1](https://github.com/teutonet/teutonet-helm-charts/releases/tag/base-cluster-v11.0.1), 1 day ago) - 
...
- [kubernetes-sigs/cluster-api-provider-openstack](https://github.com/kubernetes-sigs/cluster-api-provider-openstack) ([v0.14.0-alpha.1](https://github.com/kubernetes-sigs/cluster-api-provider-openstack/releases/tag/v0.14.0-alpha.1), 3 weeks ago) - Cluster API implementation for OpenStack
- [grafana/loki](https://github.com/grafana/loki) ([v3.6.3](https://github.com/grafana/loki/releases/tag/v3.6.3), 4 weeks ago) - Like Prometheus, but for logs.
...
- [fix(base-cluster/monitoring): add missing kube-prometheus-stack image(s/licenses)](https://github.com/teutonet/teutonet-helm-charts/pull/1888) on [teutonet/teutonet-helm-charts](https://github.com/teutonet/teutonet-helm-charts) (2 days ago)
- [fix(ci): jq argument overflow...](https://github.com/teutonet/teutonet-helm-charts/pull/1882) on [teutonet/teutonet-helm-charts](https://github.com/teutonet/teutonet-helm-charts) (3 days ago)
- [fix(base-cluster/monitoring): use correct grafana-tempo url](https://github.com/teutonet/teutonet-helm-charts/pull/1881) on [teutonet/teutonet-helm-charts](https://github.com/teutonet/teutonet-helm-charts) (3 days ago)
...
- [feat: check for CVEs during linting](https://github.com/teutonet/cluster-api-provider-hosted-control-plane/pull/66) on [teutonet/cluster-api-provider-hosted-control-plane](https://github.com/teutonet/cluster-api-provider-hosted-control-plane) (4 weeks ago)
