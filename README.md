...
- [mason-org/mason-registry](https://github.com/mason-org/mason-registry) ([2026-03-04-worst-factor](https://github.com/mason-org/mason-registry/releases/tag/2026-03-04-worst-factor), today) - Core registry for mason.nvim.
...
- [homeport/dyff](https://github.com/homeport/dyff) ([v1.11.2](https://github.com/homeport/dyff/releases/tag/v1.11.2), 3 days ago) - /ˈdʏf/ - diff tool for YAML files, and sometimes JSON
- [telepresenceio/telepresence](https://github.com/telepresenceio/telepresence) ([v2.27.0](https://github.com/telepresenceio/telepresence/releases/tag/v2.27.0), 4 days ago) - Local development against a remote Kubernetes or OpenShift cluster
...
- [feat: use upstream settings for diff](https://github.com/databus23/helm-diff/pull/939) on [databus23/helm-diff](https://github.com/databus23/helm-diff) (1 week ago)
- [fix(base-cluster/monitoring): only roll out alloy tracing ports if enabled](https://github.com/teutonet/teutonet-helm-charts/pull/2005) on [teutonet/teutonet-helm-charts](https://github.com/teutonet/teutonet-helm-charts) (1 week ago)
